...
static char cmvs_cpz3_decode_string[] = "";	
// "解析する悪い子はリコがお仕置きしちゃいます。呪われちゃいますよ～、というかもう呪っちゃいました□"
// "リコ正在惩罚破解的坏孩子.会被诅咒呦~不过已经诅咒过了"
static char cmvs_cpz5_decode_string[] = "";
									   ...
									   struct package_directory *pkg_dir)
{
	...
	BYTE *p = index;
	DWORD i, j;
	for (i = 0; i < cpz5_header.total_dir_entries_size / 4; ++i) {
		*(u32 *)p = _lrotl((*(u32 *)p ^ key[i & 3]) - 0x4A91C262, 3) - seed;
		p += 4;
		seed += 0x10FB562A;
	}
	for (j = 0; j < (cpz5_header.total_dir_entries_size & 3); ++i, ++j) {
