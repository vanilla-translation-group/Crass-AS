...
struct game_config {
	...
	{	// 催眠ペット ～メスになったワタシ～
		_T("saimin"),
		// "催眠ペット"
		"\x8D\xC3\x96\xB0\x83\x79\x83\x62\x83\x67"
	},
	{	// 姉ニモマケズ ～お姉ちゃんズは刺激的！～
		_T("anetai"),
		// 姉ニモマケズ
		"\x8E\x6F\x83\x6A\x83\x82\x83\x7D\x83\x50\x83\x59"
	},
	{	// 神出鬼没！異次元肉棒 ～こんなところからお邪魔します～
		_T("Nikubo"),
		// いちごみるく
		"\x82\xA2\x82\xBF\x82\xB2\x82\xDD\x82\xE9\x82\xAD"
	},
	{	// ふわりコンプレックス
		_T("f_complex"),
		"googlechrome"
	...
	{	// 誰かのために出来ること ～Innocent Identity～
		_T("I2"),
		// そんな事を思わずにはいられなかった。
		"\x82\xBB\x82\xF1\x82\xC8\x8E\x96\x82\xF0\x8E\x76\x82\xED\x82\xB8\x82\xC9\x82\xCD\x82\xA2\x82\xE7\x82\xEA\x82\xC8\x82\xA9\x82\xC1\x82\xBD\x81\x42"
	},
	{	// アンバークォーツ
		_T("AmberQuartz"),
		// 夕焼け。学校の屋上。そこに伸びる二つの影。
		"\x97\x5B\x8F\xC4\x82\xAF\x81\x42\x8A\x77\x8D\x5A\x82\xCC\x89\xAE\x8F\xE3\x81\x42\x82\xBB\x82\xB1\x82\xC9\x90\x4C\x82\xD1\x82\xE9\x93\xF1\x82\xC2\x82\xCC\x89\x65\x81\x42"
	},
	{	// 暁の護衛 ～プリンシパルたちの休日～
		_T("akatsuki_fd"),
		// もう足が針のようだよ
		"\x82\xE0\x82\xA4\x91\xAB\x82\xAA\x90\x6A\x82\xCC\x82\xE6\x82\xA4\x82\xBE\x82\xE6"
	},
	{	// 痴漢プレイ 電車の中で○○や××なこと
		_T("cplay"),
		// 恋人はチカン
		"\x97\xF6\x90\x6C\x82\xCD\x83\x60\x83\x4A\x83\x93"
	},
	{	// ゆ～パラ　～ただいま乳院中～
		_T("you"),
		// ガマン病院ＫＥＹ
		"\x83\x4B\x83\x7D\x83\x93\x95\x61\x89\x40\x82\x6A\x82\x64\x82\x78"
	},
	{	// ちょこっと！ファンディスク
		_T("ochige"),
		// ミーンミンミンミーン…
		"\x83\x7E\x81\x5B\x83\x93\x83\x7E\x83\x93\x83\x7E\x83\x93\x83\x7E\x81\x5B\x83\x93\x81\x63"
	},
	...
	{	// 暁の護衛
		_T("akatsuki"),
		// おぬぐり食べる？
		"\x82\xA8\x82\xCA\x82\xAE\x82\xE8\x90\x48\x82\xD7\x82\xE9\x81\x48"
	},
	{	// 催淫術師 ～恥辱まみれの絶頂～
		_T("jutu"),
		// うはうはバレンタイン
		"\x82\xA4\x82\xCD\x82\xA4\x82\xCD\x83\x6F\x83\x8C\x83\x93\x83\x5E\x83\x43\x83\x93"
	},
	{	// すいっチ！！ ～ボクがナツに想うこと～
		_T("swops"),
		"WinCVS"
	...
	{	// ナギサの
		_T("nagisano"),
		// 青い空に向かって、溜息を一つこぼす。
		"\x90\xC2\x82\xA2\x8B\xF3\x82\xC9\x8C\xFC\x82\xA9\x82\xC1\x82\xC4\x81\x41\x97\xAD\x91\xA7\x82\xF0\x88\xEA\x82\xC2\x82\xB1\x82\xDA\x82\xB7\x81\x42"
	},
	{	// 蝕獣～妹のおしり～美羽編
		_T("SYOKUJYU"),
		// スリジャヤワルダナプラコッテ
		"\x83\x58\x83\x8A\x83\x57\x83\x83\x83\x84\x83\x8F\x83\x8B\x83\x5F\x83\x69\x83\x76\x83\x89\x83\x52\x83\x62\x83\x65"
	},
	{
		NULL, NULL
	}
