...
{
	DWORD pid;
	for (pid = 0; dat_package_list[pid].name; ++pid) {
...
{
	DWORD pid;
	for (pid = 0; wav_package_list[pid].name; ++pid) {
...
{
	DWORD pid;
	for (pid = 0; sav_package_list[pid].name; ++pid) {
...
{
	DWORD pid;
	for (pid = 0; fx_package_list[pid].name; ++pid) {
